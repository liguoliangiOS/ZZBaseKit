...
public class ZZDeviceInfo: NSObject {
    ///获取系统版本
    public class func zz_getDeviceSystemVersion() -> String {
        return UIDevice.current.systemVersion
    }
    
    ///获取系统名称
    public class func zz_getDeviceSystemName() -> String {
        return UIDevice.current.systemName
    }
    
    ///获取系统名称 iPhone", "iPod touch"
    public class func zz_getDeviceModel() -> String {
        return UIDevice.current.model
    }
    
    ///获取系统名称 localized version of model
    public class func zz_getDeviceLocalizedModel() -> String {
        return UIDevice.current.localizedModel
    }
    
    ///获取设备名称 如 XXX的iphone
    public class func zz_getDeviceUserName() -> String {
        return UIDevice.current.name
    }
    ///获取总的内存
    public class func zz_getDeviceDiskTotalSize() -> String {
        return fileSizeToString(fileSize: zz_getTotalDiskSize())
    }
    
    ///获取可用的内存
    public class func zz_getDeviceAvalibleDiskSize() -> String {
        return fileSizeToString(fileSize: zz_getAvailableDiskSize())
    }
    
    ///获取运营商
    public class func zz_getDeviceSupplier() -> String {
        return zz_deviceSupplier()
    }
    
    /// 获取当前设备IP
    public class func zz_getDeviceIP() -> String {
        return zz_deviceIP()
    }
    ...
    ///获取cpu类型
    public class func zz_getDeviceCpuType() -> String {
...
///private
extension ZZDeviceInfo {
    ///获取运营商
    private class func zz_deviceSupplier() -> String {
    ...
    /// 获取当前设备IP
    private class func zz_deviceIP() -> String {
    ...
    ///获取cpu核数类型
    private class func zz_deviceCpuCount() -> Int {
    ...
    ///获取cpu类型
    private class func zz_deviceCpuType() -> String {
    ...
    ///获取设备名称
    private class func zz_deviceName() -> String {
    ...
    /// 磁盘总大小
    private class func zz_getTotalDiskSize() -> Int64 {
    ...
    /// 磁盘可用大小
    private class func zz_getAvailableDiskSize() -> Int64 {
        var fs = blankof(type: statfs.self)
        if statfs("/var",&fs) >= 0{
